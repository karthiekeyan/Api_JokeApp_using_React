...
const JokeApp = () => {
  ...
  async function getJoke ()
    ...
    function Jokes(){
        alert("Go to click Get Joke Button!");
    }

  return (
    <div className='bg-[#71717a] flex max-w-[1366px] h-[640px] justify-center text-center items-center p-7 md:[800px] border-spacing-0 backdrop-blur-2xl'>
